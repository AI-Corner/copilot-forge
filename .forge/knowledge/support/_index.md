# Copilot Forge — Support Knowledge Base

Welcome to the Master Support Document for the Copilot Forge toolkit.

## Feature Index

| Feature / Component | Keywords / Tags | Support Document |
|---------------------|-----------------|------------------|
| **Project Initialization** | init, setup, bootstrap, context, templates | [SUP-001: Project Initialization](SUP-001-init.md) |
