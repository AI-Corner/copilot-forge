...
- NO prompt/template files modified — this task produces verification artifacts only.
- `.forge/specs/REQ-258-unified-retrieval-spec-pilot/verification.md` — NEW. Records the dogfood test plan, commands run, actual output, and AC pass/fail checklist.
...
Any AC failure is a Phase 5 finding — fix in TASK-004 (spec/prompt.md) or TASK-005 (init/prompt.md), re-run the affected scenario, re-verify. Do not ship with failing scenarios.
