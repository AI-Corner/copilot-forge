...
1. **Prompt Anatomy**: Every main prompt MUST be a single markdown file at `.github/prompts/forge-<name>.prompt.md`. It MUST include YAML frontmatter, an Ethos reference, Input, Prerequisites, Instructions, and a Quality checklist.
