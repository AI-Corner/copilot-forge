...
**Do not apply any changes without explicit user approval.** Writing to `.forge/templates/` affects how future `#forge-spec`, `#forge-architect`, and `#forge-bugfix` runs behave.
