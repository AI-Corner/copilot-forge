...
3. Suggest which items warrant a full Copilot Forge requirement (candidates for `#forge-spec`).

## Internal Reference
- **Incoming Skill Dependencies**: *None*
- **Incoming Agent Dependencies**: *None*
- **Outgoing Skill Dependencies**: *None*
- **Outgoing Agent Dependencies**: `#agents/api-cost-scanner`, `#agents/db-perf-scanner`, `#agents/latency-scanner`
