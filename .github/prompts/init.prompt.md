...
**quality-radar.md** — scaffold an empty scorecard (to be filled by `#analyze`):
```markdown
# Quality Radar

*Run `#analyze` to populate this scorecard.*

| Dimension | Score | Summary |
|-----------|-------|---------|
| Code Quality | - | Run #analyze |
| Convention Compliance | - | Run #analyze |
| Security | - | Run #analyze |
| Testing | - | Run #analyze |
| Repo Hygiene | - | Run #analyze |
| **Overall** | **-** | |
```

**code-debt.md** — scaffold an empty ledger (to be filled by `#analyze` and `#review`):
```markdown
# Code Debt Ledger

*Tracked technical debt. Items are appended here by `#analyze` and `#review`.*
