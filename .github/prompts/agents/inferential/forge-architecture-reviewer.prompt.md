agent: agent
tools: [codebase]
description: Architecture, test coverage, and API contract compliance checklist. Referenced by #forge-review and #forge-proceed Phase 5.
---
...
Read `.forge/context/rules/architecture.rules.md` first — it declares the project's layering and dependency rules.
...
## Internal Reference
- **Incoming Skill Dependencies**: `#forge-review`
