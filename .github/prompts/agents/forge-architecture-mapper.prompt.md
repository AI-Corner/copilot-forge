...
agent: agent
tools: [codebase]
description: Map architectural impact and blast radius of a proposed change. Referenced by #forge-architect.
---
...
**Constraints**: READ-ONLY. No file modifications. Focus on mapping impact, not designing solutions.
...
## Internal Reference
- **Incoming Skill Dependencies**: `#forge-architect`
