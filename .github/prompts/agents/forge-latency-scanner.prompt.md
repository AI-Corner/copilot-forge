...
agent: agent
tools: [codebase]
description: Request latency and performance bottleneck scanner. Referenced by #forge-optimize.
---
...
### Middleware Overhead
- Rate limiter efficiency (checking on every request unnecessarily)
...
### Image Processing
- Operations that could be optimized (resize strategies, output format)
...
## Internal Reference
- **Incoming Skill Dependencies**: `#forge-optimize`
