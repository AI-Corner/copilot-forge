...
You are performing a self-review of recently implemented code to catch issues before the formal `#forge-review` step. This is a fast, honest assessment of your own work.
...
2. If Major issues are found, ask the user whether to fix now or note for `#forge-review`.
...
- If no issues or only minor ones: "Ready for `#forge-review`"
- If fixes were applied: "Fixes applied. Re-run `#forge-reflect` to verify, or proceed to `#forge-review`"
- If blockers remain: "Address these issues before `#forge-review`"

## Internal Reference
- **Incoming Skill Dependencies**: `#forge-proceed`
- **Incoming Agent Dependencies**: *None*
- **Outgoing Skill Dependencies**: `#forge-review`
